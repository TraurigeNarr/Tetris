...
BasicRandomizer::BasicRandomizer()
{
	...
	m_parameters.m_type_for_generation.push_back(RandomizerParameters::TypeParameters(PieceType::I, false, SDK::Color(0, 100, 100, 255).m_color));
	m_parameters.m_type_for_generation.push_back(RandomizerParameters::TypeParameters(PieceType::J, false, SDK::Color(0, 10, 230, 255).m_color));
	//m_parameters.m_type_for_generation.push_back(RandomizerParameters::TypeParameters(PieceType::L, false, SDK::Color(30, 10, 200, 255).m_color));
